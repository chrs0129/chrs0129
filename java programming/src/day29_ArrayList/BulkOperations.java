...
public class BulkOperations {
    public static void main(String[] args) {
        ...
        jobTitles.addAll(Arrays.asList("QA", "SDET", "Developer", "QA", "SDET", "Scrum Maste"));
        System.out.println(jobTitles);
        jobTitles.retainAll(Arrays.asList("QA", "SDET"));
        System.out.println(jobTitles);
        ArrayList<Integer> nums = new ArrayList<>();
        nums.addAll(Arrays.asList(1, 2, 3, 4, 5, 6, 7, 2, 3, 8, 9, 10));
        ...
        ArrayList<Integer>list2 = new ArrayList<>(convertToArrayList(arr));
